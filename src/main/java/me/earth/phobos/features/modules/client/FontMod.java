...
public class FontMod
    ...
    public Setting<Integer> fontSize = this.register(new Setting<Integer>("FontSize", Integer.valueOf(19), "Size of the font."));
    ...
    public Setting<Boolean> shadow = this.register(new Setting<Boolean>("Shadow", Boolean.valueOf(false), "Less shadow offset font."));
    public Setting<Boolean> showFonts = this.register(new Setting<Boolean>("Fonts", Boolean.valueOf(false), "Shows all fonts."));
    public Setting<Boolean> full = this.register(new Setting<Boolean>("Full", true));
